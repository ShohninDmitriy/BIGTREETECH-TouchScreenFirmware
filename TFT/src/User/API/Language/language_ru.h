...
#define _LANGUAGE_RU_H_
    ...
    #define STRING_EMULATED_M109_M190     "Эмуляция M109 / M190"
    ...
    #define STRING_MARLIN_SHOW_TITLE      "Marlin Поддержка заголовка режима"
    ...
    #define STRING_PROBING_Z_OFFSET       "Зондирование смещения Z"
    ...
    #define STRING_LCD_LOCK_ON_IDLE       "Блокировка LCD на холостом ходу"
    #define STRING_LED_ALWAYS_ON          "Подсветка постоянно включена"
    ...
    #define STRING_DELTA_CONFIGURATION    "Delta Конфигурация"
    #define STRING_DELTA_TOWER_ANGLE      "Отделка Угла Башни"
    #define STRING_DELTA_DIAGONAL_ROD     "Diagonal Rod Trim"
    #define STRING_DELTA_ENDSTOP          "Регулировка концевиков"
    ...
    #define STRING_LISTENING              "TFT в режиме прослушивания!"
    ...
    #define STRING_TFT_SD_NOT_DETECTED    "SD-карта не обнаружена."
    ...
    #define STRING_TFT_USB_NOT_DETECTED   "USB-диск не обнаружен."
    ...
    #define STRING_HS_ON                  "HS: Вкл."
    #define STRING_HS_OFF                 "HS: Выкл."
    ...
    #define STRING_MARLIN_MODE_SETTINGS   "Marlin Режим"
    ...
    #define STRING_SERIAL_PORTS           "S. Порт"
    ...
    #define STRING_CONNECT_PROBE          "Подключите зонд перед началом процесса. Обязательно отключите его после этого."
    #define STRING_DISCONNECT_PROBE       "Перед использованием этой функции убедитесь, что вы отсоединили зонд."
    #define STRING_CALIBRATION            "Калибровка"
